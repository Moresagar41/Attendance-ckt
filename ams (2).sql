...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2020 at 08:29 PM
...
('', 'InfoTech', 'infotech', 103, 'moresushant58@gmail.com'),
('', 'MBA', 'MBA', 102, 'mba@gmail.com'),
('Sagar More', 'MCA', 'mca', 101, 'sagarmore9932@gmail.com');
...
INSERT INTO `attendance` (`attd_date`, `Last_Date`, `stud_id`, `Present_Count`, `Total_Classes`, `dept_name`, `course_id`, `sub_id`, `fact_id`) VALUES
('2020-02-23', '2020-02-23', '1701', 0, 1.5, 'computer science', 101, 201, 1000),
('2020-02-23', '2020-02-23', '1703', 1.5, 1.5, 'computer science', 101, 201, 1000),
('2020-02-23', '2020-02-23', '1704', 0, 1.5, 'computer science', 101, 201, 1000),
('2020-02-24', '2020-02-24', '41', 3, 3, 'MBA department', 102, 504, 1005),
('2020-02-24', '2020-02-24', '42', 1.5, 1.5, 'MBA department', 102, 501, 1004);
...
(103, 'Information Technology', 'computer science'),
...
(1000, 'Shweta', 'Lohar', 'computer science', 'sl36@gmail.com'),
(1001, 'onkar', 'maske', 'computer science', 'omkarmaske77@gmail.com'),
(1002, 'madhavi ', 'joshi', 'computer science', 'joshimadhavi@gmail.com'),
(1003, 'Pawan', 'rai', 'computer science', 'Pr22@gmail.com'),
(1004, 'sushmita', 'more', 'MBA department', 'sushmore1997@gmail.com'),
(1005, 'Akshay ', 'Desai', 'MBA department', 'ak12@gmail.com'),
(1006, 'Aniket ', 'Shinde', 'computer science', 'aniketshinde1995@gmail.com'),
(1007, 'Sayali', 'Jadhav', 'computer science', 'jadhavsayali1998@gmail.com');
...
(1000, '1000shweta', 'shweta', 'computer science'),
(1001, '1001onkar', 'onkar', 'computer science'),
(1002, '1002madhavi', 'madhavi', 'computer science'),
(1003, '1003Pawan', 'Pawan', 'computer science'),
(1004, '1004sushmita', 'sushmita', 'MBA department'),
(1005, '1005Akshay ', 'Akshay ', 'MBA department'),
(1006, '1006Aniket ', 'Aniket ', 'computer science');
...
(4, 'Venkatesh Kamat', 'absent', '1701', 'more absent day to day', '23-02-2020', '9:41 PM');
...
('39', 'Krutik Mandre', 102, 2, '1999-03-03', 'Uran city', 'krutik38@gmail.com', 7787856421),
('40', 'Maitreya mokal', 102, 2, '1999-07-17', 'New Panvel', 'mokalmaitreya40@gmail.com', 9920619385),
('41', 'Sagar', 102, 2, '2000-06-21', 'KL-4 blg no-35 room no - 07  sec-04E kalamboli', 'sagarmore9932@gmail.com', 8169364432),
('42', 'Sushant', 102, 1, '1999-01-24', 'ONGG , palspa phata ,panvel road', 'moresushantckt58@gmail.com', 8898961059);
...
(101, 202, 'Operating System', 1001, 202),
(101, 203, 'Applied Operations Research', 1002, 203),
(101, 204, 'Probability and Statistics', 1003, 204),
(101, 205, 'Data and File Structure Lab', 1000, 205),
(101, 206, 'Operating System Lab', 1001, 206),
(102, 501, 'Marketing', 1004, 501),
(102, 502, 'HR Management', 1004, 502),
(102, 503, 'Finance Management', 1004, 503),
(102, 504, 'Business Law', 1005, 504),
(103, 601, 'Business intelligence', 1006, 601),
(103, 602, 'Software Quality Assurance', 1007, 602);
